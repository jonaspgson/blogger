...
function createAmazonLinks(productName) {
    ...
    output += '<a href="https://www.amazon.ca/s?k=' + searchString + '&tag=thejo04c9-20" target="_blank" title="Buy from Canada"><span class="flag-icon flag-icon-ca"></span> CA</a>';
    ...
    output += '<a href="https://www.amazon.de/s?k=' + searchString + '&tag=jonas00d-21" target="_blank" title="Buy from Germany (recommended for EU citizens)"><span class="flag-icon flag-icon-de"></span><span class="flag-icon flag-icon-eu"></span> DE/EU</a>';
